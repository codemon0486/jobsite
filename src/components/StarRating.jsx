...
const StarRating = () => {
  return (
    <div className="flex flex-row-reverse gap-1 justify-end items-center">
      <input
        id="hs-ratings-readonly-1"
        type="radio"
        className="peer -ms-5 size-5 bg-transparent border-0 text-transpar</React.Fragment>ent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0"
        name="hs-ratings-readonly"
        value="1"
      />
      <label
        for="hs-ratings-readonly-1"
        className="peer-checked:text-[#009DDE] text-gray-300 pointer-events-none"
      >
        <svg
